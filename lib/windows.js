...
const windows = {
  ...
  'minecraft:beacon': BeaconWindow,
  'minecraft:anvil': AnvilWindow,
  'minecraft:hopper': HopperWindow,
  'minecraft:dropper': DispenserWindow,
  'minecraft:shulker_box': ShulkerBoxWindow,
  'EntityHorse': EntityRideableWindow
}
...
function BeaconWindow(id, title, slotCount) {
  Window.call(this, id, 8, title, slotCount)
}
util.inherits(BeaconWindow, Window)

BeaconWindow.prototype.inventorySlotStart = 1

BeaconWindow.prototype.acceptUniqueClick = function(click) {
  this.acceptNonInventorySwapAreaClick(click)
};

function AnvilWindow(id, title, slotCount) {
  Window.call(this, id, 9, title, slotCount)
}
util.inherits(AnvilWindow, Window)

AnvilWindow.prototype.inventorySlotStart = 3

AnvilWindow.prototype.acceptUniqueClick = function(click) {
  this.acceptNonInventorySwapAreaClick(click)
};

function HopperWindow(id, title, slotCount) {
  Window.call(this, id, 10, title, slotCount)
}
util.inherits(HopperWindow, Window)

HopperWindow.prototype.inventorySlotStart = 5

HopperWindow.prototype.acceptUniqueClick = function(click) {
  this.acceptNonInventorySwapAreaClick(click)
};

function ShulkerBoxWindow(id, title, slotCount) {
  Window.call(this, id, 11, title, slotCount)
}
util.inherits(ShulkerBoxWindow, Window)

ShulkerBoxWindow.prototype.inventorySlotStart = 27

ShulkerBoxWindow.prototype.acceptUniqueClick = function(click) {
  this.acceptNonInventorySwapAreaClick(click)
}

function EntityRideableWindow (id, title, slotCount) {
  Window.call(this, id, 12, title, slotCount)

  this.inventorySlotStart = slotCount
}
util.inherits(EntityRideableWindow, Window)

EntityRideableWindow.prototype.acceptUniqueClick = function(click) {
  this.acceptNonInventorySwapAreaClick(click)
}
